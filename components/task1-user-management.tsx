...
export default function Home() {
  ...
  const EmptyState = () => (
    <div className="flex flex-col items-center justify-center py-12 text-center">
      ...
      <Button className="mt-4 bg-black hover:bg-gray-800" onClick={() => setIsModalOpen(true)}>
        Add New User
      </Button>
    </div>
  )
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex justify-between items-center mb-6">
              <Button size="lg" onClick={() => setIsModalOpen(true)} className="bg-black hover:bg-gray-800">
                Add New User
              </Button>
              <Select
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-background rounded-lg shadow-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <h2 className="text-xl font-semibold items-center mb-6">Add New User</h2>
